...
class RandomTimerTest {
	...
	void RT3() throws Exception {
		...
		Assert.assertEquals(rt3.toString(),"POSIBILIST LoLim:1 HiLim:2");
	...
	void RT4() throws Exception {
		...
		Assert.assertEquals(rt4.getMean(), 1 + 1/2);
		Assert.assertEquals(rt4.getDistributionParam(),"lolim: 1 hilim: 2");
		Assert.assertEquals(rt4.toString(),"GAUSSIAN LoLim:1 HiLim:2");
		}
